    ...
    <div class="col-xl-6 col-md-12">
           <div class="ms-panel ms-panel-fh">
             ...
             <div class="ms-panel-body ms-panel-fh">
               <form action="../../../Tienda" method="POST" enctype="multipart/form-data" class="ms-form-wizard ms-wizard-round style3-wizard">
                 <h3></h3>
                 ...
                 <div class="ms-wizard-step">
                   ...
                   <div class="col-md-12 mb-3">
                       <label>Barrio</label>
                       <div class="input-group">
                         <select name="textBarrio" class="form-control" required>
