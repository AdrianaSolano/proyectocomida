<%-- 
    Document   : product
    Created on : 12/09/2020, 12:17:04 PM
    Author     : adria
--%>
...
Connection con;
String url="jdbc:mysql://localhost:3306/comidaalinstante";
String Driver="com.mysql.jdbc.Driver";
String User="root";
String Clave="";
Class.forName(Driver);
con=DriverManager.getConnection(url,User,Clave);
//llamado de datos de la BD 
PreparedStatement puente;
ResultSet pue;
puente=con.prepareStatement("select * from productos");
pue=puente.executeQuery();
        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
             ...
             <button type="button" class="btn btn-danger has-icon"><i class="
add_circle_outline"></i>Registrar</button>
            <br><br><br>
        </div>
                   ...
                   <div class="col-md-12 mb-3">
                       ...
                       <div class="input-group">
                         <select class="form-control" required>
                           ...
                           <option value="">Alfonso lópez</option>
                           <option value="">Santa Librada</option>
                           <option value="">Aurora</option>
                           <option value="">Tenerife</option>
                           <option value="">La fiscala</option>
                           <option value="">Marichuela</option>
                           <option value="">Yomasa</option>
                           <option value="">Danubio Azul</option>
                  ...
                  <table class="table table-hover thead-primary">
                    ...
                    <tbody>
                        <% 
                            ...
                            List<ProductoVO>list=proDAO.listar();
                            Iterator<ProductoVO>iter=list.listIterator();
                      ...
                      <tr>
                          ...
                          <td><%= proVO.getPro_nombre()%></td>
                          <td><%= proVO.getPro_precio()%></td>
                          <td><%= proVO.getPro_descripcion()%></td>
                          <td><%= proVO.getF_tie_id()%></td>
                          <td><%= proVO.getF_tipo_pro_id()%></td>
                    ...
                    <li class="ms-rating-item rated"> <i class="material-icons">star</i> </li>
                            ...
                            <a href='a.html'><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                      </tr>
                      <tr>
