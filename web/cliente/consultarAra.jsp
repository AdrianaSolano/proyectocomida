...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <!-- Form Elements -->
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#form-elements" aria-expanded="false" aria-controls="form-elements"> <span><i class="material-icons fs-16">input</i>Estado de mis pedidos</span>
        </a>
  ...
  <main class="body-content">
    ...
    <div class="ms-content-wrapper">
        <a class="btn grid-btn mt-0 btn-sm btn-light" href="index.html">volver</a> 
        <br><br>
      <div class="row">
          ...
          <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="ms-card">
                    <div class="ms-card-img">
                      <img src="assets/img/costic/arrozju.jpg" alt="card_img">
                    </div>
                    <div class="ms-card-body">
                      
                      <div class="new">
                        <h6 class="mb-0">Arroz Diana </h6>
                        <h6 class="ms-text-primary mb-0">$2.800</h6>
                      </div>
                        <div class="new meta">
                        <p>Granos</p>
                        ...
                        <p>Cantidad</p>
                       <div class="new mb-0">
                          <a class="btn grid-btn mt-0 btn-sm btn-primary" href="../realizarPedido.jsp">Comprar</a>
                          <br>
                          <br>
                      </div>
                    </div>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="ms-card">
                    <div class="ms-card-img">
                      <img src="assets/img/costic/alqueria.jpg" alt="card_img">
                    </div>
                    <div class="ms-card-body">
                      
                      <div class="new">
                        <h6 class="mb-0">Leche Alquería</h6>
                        <h6 class="ms-text-primary mb-0">$2.400</h6>
                      </div>
                        <div class="new meta">
                        <p>Lácteos</p>
                        <span class="badge badge-success">Disponible</span>
                        ...
                        <p>Cantidad</p>
                       <div class="new mb-0">
                          <button type="button" class="btn grid-btn mt-0 btn-sm btn-primary " > Comprar</button> <br>
                          <br>
                      </div>
                        <!--<div class="new mb-0">
                            
                          <button type="button" class="btn grid-btn mt-0 btn-sm btn-outline-danger " >Añadir al carrito</button> <br>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="ms-card">
                    <div class="ms-card-img">
                      <img src="assets/img/costic/atun.jpg" alt="card_img">
                    </div>
                    <div class="ms-card-body">
                      
                      <div class="new">
                        <h6 class="mb-0">Atún VanCamp</h6>
                        <h6 class="ms-text-primary mb-0">$3.800</h6>
                      </div>
                        <div class="new meta">
                        <p>Enlatados</p>
                         <span class="badge badge-primary">Agotado</span>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="ms-card">
                    <div class="ms-card-img">
                      <img src="assets/img/costic/pasta.jpg" alt="card_img">
                    </div>
                      
                    <div class="ms-card-body">
                      
                      <div class="new">
                        <h6 class="mb-0">Pasta Doria </h6>
                        <h6 class="ms-text-primary mb-0">$1.800</h6>
                      </div>
                        <div class="new meta">
                        <p>Harinas</p>
                        <span class="badge badge-success">Disponible</span>
