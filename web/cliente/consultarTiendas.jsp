        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
            ...
            <li class="dropdown-menu-footer">
              <a class="media fs-14 p-2" href="../index.jsp"> <span><i class="flaticon-shut-down mr-2"></i>cerrar sesion</span>
              </a>
            </li>
          </ul>
        </li>
        ...
        <br><br>
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="ms-card">
                    <div class="ms-card-img">
                      <img src="assets/img/costic/araR.jpg" alt="card_img">
                    </div>
                    <div class="ms-card-body">
                        <center>
                      <div class="new">
                          
                        <h6 class="mb-0" style="align:center">Tiendas Ara </h6>
                      ...
                      <div class="new meta">
                        ...
                        <p> <strong>  Dirección: </strong> Transversal 1BIS # 68B - 33 S <br>
                            <strong>Barrio:</strong>  Quintas <br>
                            <strong>Horario:</strong> 7:00 - 21:00 <br>
                        <strong>Teléfono:</strong> 5218886</p>
                      <div class="new mb-0">
                           <a class="btn grid-btn mt-0 btn-sm btn-primary" href="pages/popups/sweet-alerts.html">Consultar</a>
                      </div>
                    </div>
                  </div>
                </div>
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="ms-card">
                    <div class="ms-card-img">
                      <img src="assets/img/costic/surtimas.jpg" alt="card_img">
                    </div>
                    <div class="ms-card-body">

                      <div class="new">
                        <h6 class="mb-0">Surtimax calle 136 </h6>
                      </div>
                      <div class="new meta">
                        <span class="badge badge-success">Abierto</span>
                      </div>
                        <p> <strong>  Dirección: </strong> Cra. 4 #136 Sur-1, Bogotá<br>
                            <strong>Barrio:</strong> Av caracas <br>
                            <strong>Horario:</strong> 7:00 - 21:00 <br>
                        <strong>Teléfono:</strong>  305 2422922</p>
                      <div class="new mb-0">
                          <button type="button" class="btn grid-btn mt-0 btn-sm btn-primary " > Consultar</button>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="ms-card">
                    <div class="ms-card-img">
                      <img src="assets/img/costic/justoy.jpg" alt="card_img">
                    </div>
                    <div class="ms-card-body">

                      <div class="new">
                        <h6 class="mb-0"> Justo y Bueno</h6>
                      </div>
                      <div class="new meta">
                        <span class="badge badge-success">Abierto</span>
                      </div>
                        <p> <strong>Dirección: </strong> CRA 14, Dg. 49 Sur #138F 43<br>
                            <strong>Barrio:</strong> Valles de cafam <br>
                            <strong>Horario:</strong> 7:00 - 21:00 <br>
                        <strong>Teléfono:</strong>34213885</p>
                        
                      <div class="new mb-0">
                            
                           <a class="btn grid-btn mt-0 btn-sm btn-primary" href="consultarAra.jsp">Consultar</a>
               ...
               <div class="col-xl-3 col-lg-4 col-md-20 col-sm-20">
                  <div class="ms-card">
                    <div class="ms-card-img">
                      <img src="assets/img/costic/rapipan.jpg" alt="card_img">
                    </div>
                    <div class="ms-card-body">

                      <div class="new">
                        <h6 class="mb-0">Panadería Rapipán </h6>
                      </div>
                      <div class="new meta">
                        <span class="badge badge-success">Abierto</span>
                      </div>
                        <p> <strong>  Dirección: </strong> Cra.6d #96 Sur-1 , Bogotá<br>
                            <strong>Barrio:</strong> Alfonso López <br>
                            <strong>Horario:</strong> 7:00 - 21:00 <br>
                        <strong>Teléfono:</strong>  3046578900</p>
                      <div class="new mb-0">
                          <button type="button" class="btn grid-btn mt-0 btn-sm btn-primary " > Consultar</button>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="ms-card">
                    <div class="ms-card-img">
                      <img src="assets/img/costic/merkandread.jpg" alt="card_img">
                    </div>
                    <div class="ms-card-body">

                      <div class="new">
                        <h6 class="mb-0">Merkandrea </h6>
                      </div>
                      <div class="new meta">
                        <span class="badge badge-success">Abierto</span>
                      </div>
                        <p> <strong>  Dirección: </strong> Cra. 9b #46<br>
                            <strong>Barrio:</strong> Santra Librada <br>
                            <strong>Horario:</strong> 7:00 - 21:00 <br>
                            <strong>Teléfono:</strong>  305 2422922</p>
                      <div class="new mb-0">
                          <button type="button" class="btn grid-btn mt-0 btn-sm btn-primary " > Consultar</button>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="ms-card">
                    <div class="ms-card-img">
                      <img src="assets/img/costic/byb.jpg" alt="card_img">
                    </div>
                    <div class="ms-card-body">

                      <div class="new">
                        <h6 class="mb-0">Brasas y Broster </h6>
                      </div>
                      <div class="new meta">
                        <span class="badge badge-success">Abierto</span>
                      </div>
                        <p> <strong>  Dirección: </strong> Transversal 2  <br>
                            <strong>Barrio:</strong> Gran Yomasa <br>
                            <strong>Horario:</strong> 7:00 - 21:00 <br>
                        <strong>Teléfono:</strong>65521888</p>
                      <div class="new mb-0">
                          <button type="button" class="btn grid-btn mt-0 btn-sm btn-primary " > Consultar</button>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="ms-card">
                    <div class="ms-card-img">
                      <img src="assets/img/costic/D2.jpg" alt="card_img">
                    </div>
                    <div class="ms-card-body">

                      <div class="new">
                        <h6 class="mb-0">Tiendas D1 </h6>
                      </div>
                      <div class="new meta">
                        <span class="badge badge-success">Abierto</span>
                      </div>
                        <p> <strong>  Dirección: </strong> Calle 33d - 69  <br>
                            <strong>Barrio:</strong> Chapinerito <br>
                            <strong>Horario:</strong> 7:00 - 21:00 <br>
                        <strong>Teléfono:</strong>  01-8000-</p>
                      <div class="new mb-0">
                          <button type="button" class="btn grid-btn mt-0 btn-sm btn-primary " > Consultar</button>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="ms-card">
                    <div class="ms-card-img">
                      <img src="assets/img/costic/ville3.jpg" alt="card_img">
                    </div>
                    <div class="ms-card-body">

                      <div class="new">
                        <h6 class="mb-0">Villetana </h6>
                      </div>
                      <div class="new meta">
                        <span class="badge badge-success">Abierto</span>
                      </div>
                        <p> <strong>  Dirección: </strong> Cra. 4 #136 Sur-1 <br>
                            <strong>Horario:</strong> 7:00 - 21:00 <br>
                        <strong>Teléfono:</strong>  305 2422922</p>
                      <div class="new mb-0">
                          <button type="button" class="btn grid-btn mt-0 btn-sm btn-primary " > Consultar</button>
