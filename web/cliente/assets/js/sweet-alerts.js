(function ($) {
  ...
  $(".ms-panel-body").on('click', '.trigger-swal', function () {
    ...
    switch (swalType) {
      ...
      case 'multi-step':
        Swal.fire({
          html: '<input type="text" placeholder=Dirección> ' +'<br><br>'  + '<input type="text" placeholder=Cantidad>',
          ...
          if (result.value) {
            Swal.fire('el pedido ha sido realizado con exito', 'consultado en tus pedidos', 'success');
          }
        });
        break;
      case 'auto-close':
