...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="index.html">
        <img src="pages/logoarriba.png" alt="logo">
      </a>
    </div>
    <!-- Navigation -->
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        <a href="pages/product/productcata.html"> <span><i class="fas fa-shopping-cart fs-16"></i>restaurantes</span>
          ...
          <a href="pages/product/productcata.html"> <span><i class="fas fa-shopping-cart fs-16"></i>Tiendas</span>
        </a>
          <li class="menu-item"> 
                   ...
                   <div class="form-row">
                     ...
                     <!--<div class="col-md-12 mb-3">
                       ...
                       <div class="input-group">
                         <input type="text" name="textPed_id" class="form-control autofocus required ">
                       </div>
                     </div>-->
                       ...
                       <label>Fecha:</label>
                       <div class="input-group">
                         <input type="text" name="textPed_fecha" class="form-control required ">
                       </div>
                     </div>
                       ...
                       <div class="input-group">
                         <input type="text" name="textPed_direccion" class="form-control required ">
                       </div>
                     </div>
                       ...
                       <div class="input-group">
                         <input type="text" name="textPed_cant_total" class="form-control required ">
                       </div>
                     </div>
                       ...
                       <label>Hora:</label>
                       <div class="input-group">
                         <input type="text" name="textPed_hora" class="form-control required ">
                       </div>
                     </div>
                
               
                
        <!--<a class="btn btn-primary item2" href="productcata.html">regresar</a>
 ...
 -->
        ...
        <div class="col-md-3">
        <button id="submit" type="submit" class="btn btn-primary" data-swal="multi-sep">Registrar</button>
        <input type="hidden" value="1" name="opcion">
        </div>
        </form>
